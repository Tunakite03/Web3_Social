...
const Context: FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // const endpoint = "https://lively-nameless-shard.solana-devnet.discover.quiknode.pro/a4dc9d50608152f1c5e0692fc305b709e4086db8/";
  ...
  useEffect(() => {
    if (wallet?.publicKey) {
      const runCode = async () => {
        ...
        const socialProtocol = await new SocialProtocol(wallet, null, {
          rpcUrl: "https://rpc.helius.xyz/?api-key=3111f6dd-08a8-486d-9b8f-46acc4cf1c76",
          useIndexer: true,
        }).init()
